...
export default function ConsumerInventoryItem(props: SelectedProduct){
    ...
    const [itemClicked, changeView] = useState(false)
    ...
    return(
       <div className="col-span-1 h-full relative flex flex-col" onClick={() => changeView(true)}>
            ...
            {itemClicked ? <ProductLoading /> : null}
        </div>
    )
}